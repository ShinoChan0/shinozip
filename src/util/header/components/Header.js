...
import ThemeSwitcher from '../../ThemeChanger/ThemeSwitcher'
import LanguageSwitcher from '../../LanguageChanger/LanguageSwitcher'
                    ...
                    <ul className="flex items-center">
                        ...
                        <li className="list-none inline-block mr-5 max-sm:mr-2">
                            <a href="https://github.com/ShinoChan0/React-Portfolio" className="flex items-center hover:opacity-40" target="_blank" rel="noreferrer">
                                ...
                                <span className="text-xl max-sm:text-lg font-bold">Source</span>
                            </a>
                        </li>
                    </ul>
                </nav>
